...
extern "C" DECLSPEC_IMPORT INT          __cdecl MSVCRT$_snwprintf(wchar_t * __restrict__ _Dest,size_t _Count,const wchar_t * __restrict__ _Format,...);
extern "C" DECLSPEC_IMPORT HRESULT      WINAPI  OLE32$CLSIDFromString (LPCOLESTR lpsz, LPCLSID pclsid);
...
extern "C" DECLSPEC_IMPORT HRESULT      WINAPI  OLE32$IIDFromString (WCHAR* IID);
...
extern "C" DECLSPEC_IMPORT SAFEARRAY*   WINAPI  OLEAUT32$SafeArrayCreate(VARTYPE vt, UINT cDims, SAFEARRAYBOUND* rgsabound);
...
extern "C" DECLSPEC_IMPORT HRESULT      WINAPI  OLEAUT32$SafeArrayPutElement(SAFEARRAY *psa, LONG *rgIndices, void *pv);
